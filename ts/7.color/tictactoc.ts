    ...
    card.addEventListener("click", function (this: HTMLDivElement) {
      if (clickFlag && !completedCard.includes(this)) {
        ...
        if (clickCard.length === 2) {
          const clickCardOne = (clickCard[0].querySelector(".card-back") as HTMLDivElement).style
            .backgroundColor;
          const clickCardTwo = (clickCard[1].querySelector(".card-back") as HTMLDivElement).style
            .backgroundColor;
